const String FETCHCATEGORIESALLDATA = r'''
query ($siteId: [Int]!, $brandId: Int, $campaignId: Int, $categoryId: Int, $collectionId: Int, $isFeatured: Boolean, $isFlash: Boolean, $isNew: Boolean, $isPrivate: Boolean, $childId: Int, $childType: Int, $percentage: JSON, $isReseller: Boolean, $isBasePrice: Boolean, $queryType: String, $search: String, $subCategoryId: Int, $subSubCategoryId: Int, $shopId: Int, $stoppageId: Int, $productType: Int, $after: String, $first: Int, $offset: Int, $minPrice: Float, $maxPrice: Float) {
  storeProducts(
    siteId: $siteId
    brandId: $brandId
