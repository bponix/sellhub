const String FETCHSUBCATEGORIES = r'''
query ($siteId: [Int]!, $categoryId: Int, $isActive: Boolean, $isPrivate: Boolean, $first: Int, $after: String) {
  storeSubCategories(
    siteId: $siteId
...
const String FETCHSUBCATEGORIESDATA = r'''
