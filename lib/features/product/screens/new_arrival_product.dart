...
class NewArrivalProductScreen extends StatefulWidget {
  ...
  @override
  State<NewArrivalProductScreen> createState() =>
      _NewArrivalProductScreenState();
}
...
class _NewArrivalProductScreenState extends State<NewArrivalProductScreen> {
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: _CollectionHero(
                    ...
                    count: storefrontState.newArrival.length,
                  ),
                ),
              ),
              SliverToBoxAdapter(
  ...
  Future<void> _shareCollection(BuildContext context) async {
    ...
    final text = SellHubShareLinkBuilder.buildCollectionShareText(
      store: store,
      collectionType: CollectionLinkScreen.newArrivals,
      title: 'New arrivals',
    );
    await Share.share(text, subject: 'New arrivals');
  }
}
