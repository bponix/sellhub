const String FETCHPRODUCTDETAILSBYSEARCH = r'''
query ($siteId: [Int]!, $brandId: Int, $campaignId: Int, $categoryId: Int, $collectionId: Int, $isFeatured: Boolean, $isFlash: Boolean, $isNew: Boolean, $isPrivate: Boolean, $childId: Int, $childType: Int, $percentage: JSON, $isReseller: Boolean, $isBasePrice: Boolean, $queryType: String, $search: String, $subCategoryId: Int, $subSubCategoryId: Int, $tagIds: [Int], $shopId: Int, $stoppageId: Int, $productType: Int, $after: String, $first: Int, $offset: Int) {
  storeProducts(
    siteId: $siteId
    brandId: $brandId
